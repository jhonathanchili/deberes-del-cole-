...
function colision(obj1,obj2){
    if (obj1.x < obj2.x + obj2.width &&
        ...
        obj1.height + obj1.y > obj2.y) {
            ...
            puntosFinal =  buclePrincipal.seg; 
...
function escenaJuego(){
    ...
    ctx.fillStyle="#000";
    ctx.fillText("tiempo transcurrido : " + buclePrincipal.seg ,10,30);
    ...
    if(pause) {// si el juego esta pausado
        ...
        ctx.fillStyle = "#000";
        turnoImg+=0.05;
        ctx.fillText("Reiniciar juego",cw/2,ch/2);
        ctx.fillText("Total de puntos : " + puntosFinal, cw/2, ch/2-100);
        ctx.restore();
    }
